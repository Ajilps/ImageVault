...
if (isMinio && !credentials) {
    throw new AppError("MINIO_ACCESS_KEY and MINIO_SECRET_KEY must be configured for MinIO storage.", 500, "CONFIGURATION_ERROR");
}
...
export async function assertUploadedImage(objectKey) {
    try {
...
export function storageUri(objectKey) {
